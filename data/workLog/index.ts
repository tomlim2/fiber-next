export const flfi = [
  {
    name: "Dogo Bricks",
    description: "nft 프로젝트",
    type: "nft",
    tasks: [
      "프론트 페이지 개발",
      "3D 모델링 제작 및 threejs로 웹사이트에 구현",
      "홍보 및 웹페이지용 케릭터 애니메이션 및 영상 제작",
    ],
    advantures: [
      "vue3에서 프레임워크 라이프 사이클의 이해",
  ...
  {
    name: "OG community",
    description: "크립토 커뮤니티 서비스 mvp 개발",
    type: "cummunity",
    tasks: ["유저 페이지", "위젯 페이지", "로그인/회원가입 플로우"],
    advantures: [
      "vue2 + typescript 환경에서 Google GIS으로 로그인 구현",
