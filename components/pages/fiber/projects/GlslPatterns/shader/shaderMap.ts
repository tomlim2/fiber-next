...
import Pattern36Fragment from "raw-loader!glslify-loader!./pattern36/fragment.glsl";
import Pattern36Vertex from "raw-loader!glslify-loader!./pattern36/vertex.glsl";
import Pattern37Fragment from "raw-loader!glslify-loader!./pattern37/fragment.glsl";
import Pattern37Vertex from "raw-loader!glslify-loader!./pattern37/vertex.glsl";
import Pattern38Fragment from "raw-loader!glslify-loader!./pattern38/fragment.glsl";
import Pattern38Vertex from "raw-loader!glslify-loader!./pattern38/vertex.glsl";
import Pattern39Fragment from "raw-loader!glslify-loader!./pattern39/fragment.glsl";
import Pattern39Vertex from "raw-loader!glslify-loader!./pattern39/vertex.glsl";
import Pattern40Fragment from "raw-loader!glslify-loader!./pattern40/fragment.glsl";
import Pattern40Vertex from "raw-loader!glslify-loader!./pattern40/vertex.glsl";
import Pattern41Fragment from "raw-loader!glslify-loader!./pattern41/fragment.glsl";
import Pattern41Vertex from "raw-loader!glslify-loader!./pattern41/vertex.glsl";
import Pattern42Fragment from "raw-loader!glslify-loader!./pattern42/fragment.glsl";
import Pattern42Vertex from "raw-loader!glslify-loader!./pattern42/vertex.glsl";
import Pattern43Fragment from "raw-loader!glslify-loader!./pattern43/fragment.glsl";
import Pattern43Vertex from "raw-loader!glslify-loader!./pattern43/vertex.glsl";
import Pattern44Fragment from "raw-loader!glslify-loader!./pattern44/fragment.glsl";
import Pattern44Vertex from "raw-loader!glslify-loader!./pattern44/vertex.glsl";
import Pattern45Fragment from "raw-loader!glslify-loader!./pattern45/fragment.glsl";
import Pattern45Vertex from "raw-loader!glslify-loader!./pattern45/vertex.glsl";
import Pattern46Fragment from "raw-loader!glslify-loader!./pattern46/fragment.glsl";
import Pattern46Vertex from "raw-loader!glslify-loader!./pattern46/vertex.glsl";
import Pattern47Fragment from "raw-loader!glslify-loader!./pattern47/fragment.glsl";
import Pattern47Vertex from "raw-loader!glslify-loader!./pattern47/vertex.glsl";
import Pattern48Fragment from "raw-loader!glslify-loader!./pattern48/fragment.glsl";
import Pattern48Vertex from "raw-loader!glslify-loader!./pattern48/vertex.glsl";
import Pattern49Fragment from "raw-loader!glslify-loader!./pattern49/fragment.glsl";
...
export const shaderMap: ShaderMap[] = [
  ...
  { fragment: Pattern36Fragment, vertex: Pattern36Vertex },
  { fragment: Pattern37Fragment, vertex: Pattern37Vertex },
  { fragment: Pattern38Fragment, vertex: Pattern38Vertex },
  { fragment: Pattern39Fragment, vertex: Pattern39Vertex },
  { fragment: Pattern40Fragment, vertex: Pattern40Vertex },
  { fragment: Pattern41Fragment, vertex: Pattern41Vertex },
  { fragment: Pattern42Fragment, vertex: Pattern42Vertex },
  { fragment: Pattern43Fragment, vertex: Pattern43Vertex },
  { fragment: Pattern44Fragment, vertex: Pattern44Vertex },
  { fragment: Pattern45Fragment, vertex: Pattern45Vertex },
  { fragment: Pattern46Fragment, vertex: Pattern46Vertex },
  { fragment: Pattern47Fragment, vertex: Pattern47Vertex },
