  ...
  return (
    <Section>
      <Paragraph usage="about">
        안녕하세요! 현재 한국 서울에 위치한 영상 제작 툴을 만드는 회사인 시나몬에서 테크니컬 아티스트로 일하고 있는 임연수입니다. 그래픽을 탐구하는 것을 좋아하고 시각적인 상징성과 기호 뿐만 아니라 그것을 구현하는 방법들 중 특히 애니메이션과 프로그래밍에 대해 관심이 많습니다. 현재는 GLSL를 통한 세이더를 독학 중입니다.
        <br />
        <br />
